$(function(){
	...
	$('.banner').each(function(){
		...
		var shiyanshis=e.attr("data-shiyanshi");
		var shiyanshis_s=e.attr("data-small");
		var shiyanshis_m=e.attr("data-middle");
		var shiyanshis_b=e.attr("data-big");
		var num=e.find(".carousel .shiyanshi").length;
		var win=$(window).width();
		var i=1;

		if(interval==null){interval=5};
		if(shiyanshis==null || shiyanshis<1){shiyanshis=1};
		if(shiyanshis_s!=null && win>760){shiyanshis=shiyanshis_s};
		if(shiyanshis_m!=null && win>1000){shiyanshis=shiyanshis_m};
		if(shiyanshis_b!=null && win>1200){shiyanshis=shiyanshis_b};

		var shiyanshiWidth=Math.ceil(e.outerWidth()/shiyanshis);
		var page=Math.ceil(num/shiyanshis);
		e.find(".carousel .shiyanshi").css("width",shiyanshiWidth+ "px");
		e.find(".carousel").css("width",shiyanshiWidth*num + "px");
		
		var carousel=function(){
			i++;
			if(i>page){i=1;}
			$showbanner(e,i,shiyanshis,num);
		};
		...
		if(pointer!=0 && page>1){
			...
			pager.find("li").click(function(){
				$showbanner(e,$(this).val(),shiyanshis,num);
			});
	...
	$showbanner=function(e,i,shiyanshis,num){
		var after=0,leftx=0;
		leftx = - Math.ceil(e.outerWidth()/shiyanshis)*(shiyanshis)*(i-1);
		if(i*shiyanshis > num){after=i*shiyanshis-num;leftx= - Math.ceil(e.outerWidth()/shiyanshis)*(num-shiyanshis);};
